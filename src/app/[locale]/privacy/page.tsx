    ...
    <section className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="flex flex-col gap-8 text-gray-600 text-sm leading-relaxed">
        {isNl ? (
          <>
            ...
            <div>
              ...
              <p>
                ...
                worden verzameld. Wij hanteren een bewaartermijn van 7 jaar voor
                persoonsgegevens.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                voor de technische werking van de website en uw gebruiksgemak.
            ...
            <div>
              ...
              <p className="mb-3">
                ...
                door U.S. Basketball en heeft u het recht op
              ...
              <p>
                U.S. Basketball wil u er tevens op wijzen dat u de mogelijkheid
            ...
            <div>
              ...
              <p>
                U.S. Basketball neemt de bescherming van uw gegevens serieus en
          ...
          <>
            <p>
              U.S. Basketball, established at Tweede Boerhaavestraat 10, 1091AN
              Amsterdam, is responsible for the processing of personal data as
            ...
            <div>
              ...
              <p className="mb-3">
                U.S. Basketball processes your personal data because you use our
                services and/or because you have provided it to us yourself.
            ...
            <div>
              ...
              <p>
                ...
                website visitors under the age of 16, unless they have
                permission from parents or guardians. However, we cannot verify
                whether a visitor is older than 16. We therefore encourage
                parents to be involved in their children&apos;s online
                activities to prevent data about children being collected without
                parental consent. If you believe we have collected personal data
                about a minor without such consent, please contact us at{" "}
                <a
                  href={`mailto:${CONTACT_EMAIL}`}
                  className="text-gray-900 font-medium hover:underline"
                >
            ...
            <div>
              ...
              <ul className="list-disc list-inside flex flex-col gap-1">
                ...
                <li>
                  Calling or emailing you when necessary to perform our services
                </li>
            ...
            <div>
              ...
              <p>
                U.S. Basketball only uses technical and functional cookies, and
                analytical cookies that do not infringe on your privacy. A
                cookie is a small text file stored on your computer, tablet, or
                smartphone during your first visit to this website. The cookies
                we use are necessary for the technical functioning of the
                website and your ease of use. They ensure the website works
                properly and remember your preferences. We also use them to
                optimise our website. You can opt out of cookies by configuring
                your browser to no longer store cookies. You can also delete
                previously stored information through your browser settings.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-3">
                ...
                processing, to object to the processing of your personal data by
                U.S. Basketball, and the right to data portability — meaning you
                can request that we send the personal data we hold about you to
                you or another organisation you specify, in a computer-readable
                format.
              </p>
              <p className="mb-3">
              ...
              <p className="mb-3">
                ...
                include a copy of your ID. Please black out your passport photo,
                MRZ (the strip with numbers at the bottom of the passport),
                passport number, and citizen service number (BSN) to protect
                your privacy. We will respond as soon as possible, and within
                four weeks.
              </p>
              <p>
            ...
            <div>
              ...
              <p>
                U.S. Basketball takes the protection of your data seriously and
                implements appropriate measures to prevent misuse, loss,
